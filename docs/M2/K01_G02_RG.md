...
| A02 | Login menggunakan akun ITB | Pelanggan dan pembeli hanya bisa menggunakan akun dengan domain itb.ac.id | US-01 |
| A03 | Membuat listing barang yang ingin dijual | Penjual membuat listing barang yang nantinya akan ditunjukkan oleh sistem kepada calon pembeli | US-02, US-04 |
| A04 | Mencari barang yang diinginkan berdasarkan nama, harga, kategori, dan sebagainya | Pembeli mencari barang berdasarkan kategori yang diinginkan dan sistem akan menunjukkan sesuai yang diminta | US-03 |
...
| A06 | Melakukan transaksi COD| Pembeli dan penjual melakukan transaksi COD secara langsung (offline)| US-05 |
| A07 | Menandai barang sudah terjual | Sistem tidak akan menampilkan kembali list barang yang sudah dilabeli terjual sehingga menghindari kesalahpahaman | US-06 |
...
| A10 | Mengirimkan laporan masalah | Penjual dan pembeli melaporkan listing, akun pengguna lain, percakapan, atau *bug* platform melalui formulir pelaporan agar dapat ditinjau admin | US-07 |
## 2.3 Pemetaan Kebutuhan

| ID Kebutuhan | ID Aktivitas | Jenis Kebutuhan | Deskripsi Kebutuhan | P/L |
| :--- | :--- | :--- | :--- | :--- |
| R01 | A01, A02 | User | Pengguna dapat mendaftarkan akun baru dan masuk (*login*) ke sistem menggunakan surel serta kata sandi miliknya. | Ya |
...
| R04 | A01, A02 | System | Kata sandi pengguna harus disimpan dalam bentuk *hash* (bcrypt) dan tidak pernah disimpan maupun ditampilkan dalam bentuk *plain-text*. | Ya |
...
| R06 | A03 | User | Penjual dapat membuat, melihat, mengubah, dan menghapus listing barang miliknya beserta informasi judul, harga, deskripsi kondisi, kategori, lokasi, dan foto. | Ya |
| R07 | A03 | Business | Listing hanya sah dipublikasikan bila memuat sekurang-kurangnya satu foto barang, harga, dan kategori yang valid; barang terlarang dan jasa tidak diperbolehkan. | Ya |
| R08 | A03 | Business | Penjual hanya berhak mengubah atau menghapus listing miliknya sendiri. | Ya |
| R09 | A03 | System | Sistem harus membatasi berkas foto yang diunggah pada format JPG/PNG, ukuran maksimum 5 MB per berkas, dan maksimum 5 foto per listing. | Ya |
| R10 | A04 | User | Pembeli dapat mencari barang berdasarkan kata kunci serta menyaring dan mengurutkan hasil berdasarkan kategori, rentang harga, dan lokasi. | Ya |
| R11 | A04 | System | Sistem harus menampilkan hasil pencarian secara bertahap (paginasi) agar waktu muat halaman katalog tetap wajar meskipun jumlah listing bertambah. | Ya |
| R12 | A04 | Business | Katalog dan hasil pencarian hanya boleh memuat listing berstatus tersedia dan milik akun yang tidak sedang diblokir. | Ya |
| R13 | A05 | User | Penjual dan pembeli dapat saling berkirim pesan teks di dalam platform melalui ruang percakapan yang terkait dengan suatu listing. | Ya |
| R14 | A05 | System | Sistem harus memberi tanda atau notifikasi adanya pesan baru kepada pengguna yang dituju walau perangkat lunak sedang ditutup. | Ya |
| R15 | A06 | Business | Negosiasi harga, pembayaran, dan serah terima barang dilakukan langsung antarpengguna secara COD di dunia nyata, sehingga sistem tidak menangani pembayaran maupun penjaminan transaksi. | Tidak |
...
| R18 | A07 | User | Penjual dapat menandai listing miliknya sebagai terjual dan membatalkan penandaan tersebut bila keliru. | Ya |
| R19 | A07 | System | Sistem harus menyembunyikan listing berstatus terjual dari katalog dan hasil pencarian, namun tetap menyimpannya pada riwayat penjual. | Ya |
| R20 | A10 | User | Pengguna dapat mengirimkan laporan terhadap listing, akun, atau *bug* platform dengan menyertakan kategori masalah, alasan, dan bukti pendukung. | Ya |
| R21 | A08 | User | Admin dapat melihat, menyaring, dan meninjau seluruh laporan yang masuk beserta statusnya. | Ya |
| R22 | A08 | Business | Setiap laporan yang masuk harus ditinjau admin selambat-lambatnya 2x24 jam sejak diterima. | Tidak |
| R23 | A08 | System | Sistem harus mencatat riwayat setiap laporan beserta tindak lanjutnya. | Ya |
| R24 | A09 | User | Admin dapat menghapus listing yang bermasalah serta memblokir dan membuka blokir akun pengguna yang melanggar. | Ya |
| R25 | A09 | Business | Tindakan penghapusan listing atau pemblokiran akun hanya boleh dilakukan setelah laporan diverifikasi, dan pengguna yang dikenai tindakan harus diberitahu beserta alasannya. | Ya |
| R26 | A09 | System | Akun yang diblokir tidak dapat masuk ke sistem, seluruh listing miliknya otomatis dinonaktifkan, dan setiap tindakan moderasi tercatat pada *log* admin. | Ya |
| R27 | A09 | System | Sistem harus membatasi akses fitur moderasi hanya kepada akun dengan peran admin. | Ya |
