...
| Revisi | Deskripsi |
| :--- | :--- |
| A | Perbaikan *traceability* pada dokumen *Requirement Gathering* (Milestone 2) berdasarkan catatan asistensi Milestone 3 no. 8. Kolom ID Aktivitas pada tabel 2.3 masih memakai penomoran aktivitas lama (sebelum A01 dipecah menjadi A01 Mendaftar dan A02 Login serta A06 Transaksi COD ditambahkan), sehingga R06–R27 menunjuk ke aktivitas yang tidak sesuai (contoh: KF20 → R08 → A02 "Login", KF42 → R19 → A06 "Transaksi COD"). Kolom tersebut digeser ke penomoran yang benar. |
| B | Perbaikan kolom ID User Story pada tabel 2.2 Milestone 2 dengan pola pergeseran yang sama: A02 → US-01; A03 → US-02, US-04; A04 → US-03; A06 → US-05; A07 → US-06. |
| C | Penambahan aktivitas A10 "Mengirimkan laporan masalah" (US-07) pada tabel 2.2 Milestone 2, karena kebutuhan pengguna untuk mengirim laporan (US-07, R20) sebelumnya tidak memiliki aktivitas sehingga UC19 "Mengirimkan Laporan" tidak dapat ditelusuri ke aktivitas mana pun. |
| D | Kolom "Kebutuhan" pada tabel KF di BAB 2 dokumen ini diseragamkan menjadi ID kebutuhan (R01, R02, dst.) sesuai catatan asistensi Milestone 3 no. 7, dan nama UC15 diubah dari "Melihat Detail Listing" menjadi "Melihat Detail Katalog" sesuai catatan no. 6.  |
